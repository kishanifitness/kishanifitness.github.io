...
export function Programs() {
  ...
  const programInclusions = [
    {
      ...
      description: 'Get personalized attention and guidance from your dedicated coach every week to ensure you stay on track.'
    },
    {
    ...
    },
    {
      ...
      description: 'Submit your workout videos and receive detailed feedback to master proper form and prevent injuries.'
    },
    {
  ...
  const featuredProgram = {
    ...
    price: 98,
    description:
      'Build lean muscle and shed fat with our most comprehensive program',
    weeks: [
      {
        week: 1,
        title: 'Foundation',
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-black text-white rounded-xl overflow-hidden shadow-xl mb-8">
            ...
            <div className="relative aspect-video bg-black w-full">
              <video
                ...
                poster="/coach-video-thumbnail.jpg"
              >
                <source src="/coach-intro.mp4" type="video/mp4" />
          ...
          <div>
            ...
            <p className="text-center text-gray-600 mb-6">
              Be the first to know when these programs launch
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {comingSoonPrograms.map((program, index) => (
                <div
                  key={index}
                  className="relative bg-gradient-to-br from-gray-900 to-gray-700 rounded-xl p-6 shadow-xl overflow-hidden group hover:shadow-2xl transition-all"
                >
                  ...
                  <div className="relative z-10">
                    <div className="inline-block bg-white/20 backdrop-blur-sm text-white text-xs font-bold px-2 py-1 rounded-full mb-3">
                      COMING SOON
                    </div>
                    <h4 className="text-2xl font-bold text-white mb-1">
                      {program.title}
                    </h4>
                    <p className="text-xs text-gray-300 font-semibold mb-3 uppercase tracking-wide">
                      {program.subtitle}
                    </p>
                    ...
                    <Button
                      onClick={scrollToHero}
                      className="w-full bg-white text-black hover:bg-gray-100 font-bold py-3 rounded-lg transition-all"
                    >
                      Get Notified
                    </Button>
                  </div>
